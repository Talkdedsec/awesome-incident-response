...
* [wymcmd](https://github.com/Talkdedsec/tlk-wymcmd) - Reconstructs why a console process was launched after it has already exited, correlating Security 4688 events, Task Scheduler logs, PowerShell script blocks, Prefetch, BAM, UserAssist and AmCache into a single ancestor chain, with the evidence behind each conclusion and an optional ETW AutoLogger black box that requires no resident process.
